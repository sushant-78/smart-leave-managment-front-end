...
interface AdminLeaveDetailPopupProps {
  leave: ManagerLeave | null;
  open: boolean;
  onClose: () => void;
}

const AdminLeaveDetailPopup: React.FC<AdminLeaveDetailPopupProps> = ({
  leave,
  open,
  onClose,
}) => {
    ...
    <>
      <Dialog open={open} onClose={handleClose} maxWidth="md" fullWidth>
        <DialogTitle>
          ...
          >
            <Typography variant="h6">Manager Leave Request Details</Typography>
...
export default AdminLeaveDetailPopup;
